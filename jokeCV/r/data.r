...
skills <- tribble(
  ~area, ~skills,
  "Field","Identification and enumeration of juvenile and adult fishes (Better than Trevor), Spawning ground surveys (Fresher Legs than Trevor), Fish sorting by mark type (Trevor is better at this...in his dreams!), 
           Creel (Trevor can have this one, it sucks anyway), Operation of Tacoma Power adult and juvenile fish collection facilities(Despite my lesser experience, Better than Trevor), PIT Tagging (I saw Trevor drop a fish once!), Familiarity with Tacoma Power projects and operations (We both know nothing about this), Biosampling, Electrofishing (Shocking news, Better than Trevor), Seine netting (I have inseinly more skill than Trevor), trawling (Trevor doesn't know what this is), Gill netting (Trevor does this illegally), GoPro photography and videography (Trevor has to call me for help), 
           Radio telemetry (Toss up between Trevor and I), Water quality testing (Better than Trevor), Swift water safety (), Rafting (Trevor still hasn't taught me because he is scared I'll be better), Angling (Hard to say, Trevor won't invite me fishing), Camping, Boating (Scott is teaching us both and personally told me I'm better)",
